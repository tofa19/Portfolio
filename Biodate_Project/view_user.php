...
<head>
    ...
    <title>View User - <?php echo htmlspecialchars($user['fullName']); ?></title>
    <link rel="stylesheet" href="style.css">
</head>
<body>
    <div class="container">
        <h1>User Details: <?php echo htmlspecialchars($user['fullName']); ?></h1>
        
        <div class="dashboard-nav">
            <input type="button" value="Back to Dashboard" width="15%" class="submit-btn" onclick="window.location.href='admin_dashboard.php'">
        </div>
       <br> 
        ...
        <fieldset class="section">
            ...
            <?php if ($biodata['photo']): ?>
                <p><strong>Photo:</strong><br> <img src="<?php echo htmlspecialchars($biodata['photo']); ?>" width="150" height="160"></p>
            <?php endif; ?>
        <?php endif; ?>
        </fieldset>
        <fieldset class="section">
